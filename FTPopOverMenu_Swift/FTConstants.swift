...
struct FT {
    ...
    internal static let DefaultTintColor : UIColor = UIColor(red: 80/255, green: 80/255, blue: 80/255, alpha: 1)
    internal static let PopOverMenuTableViewCellIndentifier : String = "FTPopOverMenuTableViewCellIndentifier"
}
